...
\begin{lemma}
Let $f$ defined in \ref{eq:problemRP}, $f$ quadratic and strictly convex with respect to $\theta$. Let us define a sequence 
then if $\lim_{k \to \infty} f(x^{k},\theta^k)-f(x^{k},\theta^{k+1})=0$ then:
\begin{equation}
