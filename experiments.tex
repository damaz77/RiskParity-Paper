...
\begin{figure}
\makebox[\textwidth][c]{
\subfloat[Comparison of average execution time with {$\epsilon=10^{-10}$} on the NASDAQ-2196 dataset\label{subfig-1:time}]{%
\begin{tikzpicture}
\begin{axis}[%
xlabel={\# of assets},
ylabel={Exe Time (s)},
...
\hfill
\hspace{1em}\subfloat[Comparison of average iterations performed to converge with {$\epsilon=10^{-10}$} on the NASDAQ-2196 dataset\label{subfig-2:iterations}]{%
\begin{tikzpicture}
\begin{axis}[%
xlabel={\# of assets},
ylabel={Iterations},
