...
In Fig.(\ref{fig:perf}) all the results are reported for $\epsilon = 10^{-10}$. This value of $\epsilon$ is such that the obtained solutions $(x^*,y^*)$ satisfies
...
legend pos=north west,
title=\textbf{Average iterations number with {$\epsilon=10^{-10}$}}
]
\addplot [color=blue,solid,mark=x,mark options={solid}]
  table[row sep=crcr]{%
%50	242\\
